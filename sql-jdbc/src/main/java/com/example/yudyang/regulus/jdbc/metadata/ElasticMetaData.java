package com.example.yudyang.regulus.jdbc.metadata;
...
public class ElasticMetaData implements DatabaseMetaData {
    ...
    public ElasticMetaData(String url, String username) {
        this.url = url;
